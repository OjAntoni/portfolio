window.addEventListener("scroll", () => {
  let information = document.querySelector(".contact");
  let informationTitle = document.querySelector(".contact__header");
...
function adjustFontSize() {
  ...
  const text = document.querySelector(".contact__header");
