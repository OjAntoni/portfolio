window.addEventListener("scroll", () => {
  let information = document.querySelector(".projects");
  let informationTitle = document.querySelector(".projects__title");
...
function adjustFontSize() {
  ...
  const text = document.querySelector(".projects__title");
